...
beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.ua", os.getenv("HOME"), chosen_theme))
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "b", function() awful.util.spawn(browser)  end,
              {description = "launch browser", group = "jake-pauls"})
)
...
-- Disable sloppy focus, click or hotkey to switch focus
